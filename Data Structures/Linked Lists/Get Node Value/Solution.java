...
class Result {
    ...
    public static int getNode(SinglyLinkedListNode llist, int positionFromTail) {
        ...
        // Move the 'fast' pointer 'positionFromTail' positions ahead
        for (int i = 0; i < positionFromTail; i++) {
            if (fast == null) {
                // The linked list does not have enough nodes
                return -1;  // Or any suitable value to indicate an invalid position
            }
            fast = fast.next;
        }
